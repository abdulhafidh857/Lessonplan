...
<head>
    ...
    <title>Create Lesson Plan - Enhanced Lesson Plan System</title>
    ...
    <div class="container">
        ...
        <header class="header">
            <div class="header-content">
                <h1><i class="fas fa-plus-circle"></i> Create New Lesson Plan</h1>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="description" name="description" required rows="3"
                                          placeholder="Brief description of the lesson"><?= htmlspecialchars($_POST['description'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="objectives" name="objectives" required rows="4"
                                          placeholder="List the learning objectives for this lesson"><?= htmlspecialchars($_POST['objectives'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="materials" name="materials" rows="3"
                                          placeholder="List all materials, resources, and equipment needed"><?= htmlspecialchars($_POST['materials'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="content" name="content" required rows="8"
                                          placeholder="Detailed lesson content, activities, and teaching strategies"><?= htmlspecialchars($_POST['content'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="assessment" name="assessment" rows="4"
                                          placeholder="How will you assess student learning and understanding?"><?= htmlspecialchars($_POST['assessment'] ?? '') ?></textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="homework" name="homework" rows="3"
                                          placeholder="Homework or follow-up activities (if any)"><?= htmlspecialchars($_POST['homework'] ?? '') ?></textarea>
                            </div>
                        </div>
                    </div>
